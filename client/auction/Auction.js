        ...
        <div className={classes.root}>
              <Card className={classes.card}>
                <CardHeader
                  ...
                  subheader={<span>
                    {currentDate < new Date(auction.bidStart) && 'Lelang Belum Dimulai'}
                    {currentDate > new Date(auction.bidStart) && currentDate < new Date(auction.bidEnd) && 'Lelang Sedang Dilaksanakan'}
                    {currentDate > new Date(auction.bidEnd) && 'Lelang Sudah Berakhir'}
                    </span>}
                />
