    ...
    return (<div>
      <Card className={classes.card}>
        <CardContent>
          ...
          <TextField id="name" label="Nama Produk" className={classes.textField} value={values.itemName} onChange={handleChange('itemName')} margin="normal"/><br/>
          <TextField
            ...
            margin="normal"
          /><br/>
          <TextField id="startingBid" label="Harga Awal (Rp.)" className={classes.textField} value={values.startingBid} onChange={handleChange('startingBid')} margin="normal"/><br/>
          <br/>
          <TextField
            id="datetime-local"
